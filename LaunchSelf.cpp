...
ULaunchSelf::ULaunchSelf()
{
    InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;
}

void ULaunchSelf::LaunchSelf(AActor* ClosestActor)
{
    if (!ClosestActor)
        return;
...
/*
ACharacter* ULaunchSelf::GetOwnedActor();
{
    const FGameplayAbilityActorInfo* ActorInfo = GetCurrentActorInfo();
...
/*
TArray<FVector> ULaunchSelf::RaisedPointsArray(TArray<FVector> PointsArray)
{
